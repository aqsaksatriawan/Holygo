  ...
  <Plus className="w-8 h-8 text-[#1A1A1A]" strokeWidth={2.5} />
          ...
          {doas.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center -mt-10">
              <div className="relative mb-6">
                <div className="w-[120px] h-[120px] bg-[#F0F5FF] rounded-full flex items-center justify-center">
                  <ClipboardPlus className="w-[60px] h-[60px] text-[#1D4ED8] stroke-[1.5]" />
                </div>
                {/* little sparkles/stars */}
                <Sparkles className="absolute top-2 left-0 w-4 h-4 text-blue-300" />
                <Sparkles className="absolute top-4 right-0 w-5 h-5 text-blue-300" />
              ...
              <p className="text-[13px] text-[#6B7280] text-center max-w-[240px] mb-8 leading-relaxed">
                Silahkan tambahkan doa untuk putaran thawaf ke-{round}.
              </p>
              <button 
                onClick={() => setShowModal(true)}
                className="h-[46px] px-6 rounded-[14px] bg-[#1D4ED8] text-white text-[14px] font-bold shadow-md shadow-blue-200 flex items-center gap-2 transition hover:bg-blue-700"
              >
                  ...
                  <div key={doa.id} className="bg-white border border-[#E5E7EB] rounded-2xl p-4 shadow-sm flex flex-col gap-3">
                    ...
                    <div className="flex items-start justify-between w-full">
                      ...
                      <button
                        ...
                        className={`w-9 h-9 rounded-full shrink-0 flex items-center justify-center transition ${
                          currentPlayingId === doa.id ? "bg-[#3B82F6]" : "bg-[#1D4ED8] hover:bg-blue-700"
                        }`}
                      >
                    ...
                    <div className="flex flex-col gap-1 w-full">
                      <div className="flex items-center gap-1.5">
                        <Volume2 className="w-3.5 h-3.5 text-[#1D4ED8]" strokeWidth={2.5} />
                        <span className="text-[#1D4ED8] text-[11px] font-bold">Latin</span>
                      </div>
                      <p className="text-[#1D4ED8] font-bold text-[13px]">{doa.latin}</p>
        ...
        <div className="absolute bottom-6 right-5 z-40">
          <button 
            ...
            className="h-[44px] px-5 rounded-xl bg-[#1D4ED8] text-white text-[14px] font-bold shadow-lg shadow-blue-300 flex items-center gap-2 transition hover:bg-blue-700"
          >
            LANJUTKAN
